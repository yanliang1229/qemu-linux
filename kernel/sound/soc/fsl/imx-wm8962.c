...
static int imx_wm8962_probe(struct platform_device *pdev)
{
	...
	data->dai_link.name = "HiFi";
	data->dai_link.stream_name = "HiFi";
	data->dai_link.codec_dai_name = "wm8962";
	data->dai_link.codec_of_node = codec_np;
	data->dai_link.cpu_dai_name = dev_name(&ssi_pdev->dev);
	data->dai_link.platform_of_node = ssi_np;
	data->dai_link.ops = &imx_hifi_ops;
