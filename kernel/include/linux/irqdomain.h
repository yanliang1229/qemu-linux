 ...
 * 例如PowerPC 系统使用的MPIC (Multi-Processor Interrupt Controller),在
 * 这种情况下,不需要进行映射，我们直接把IRQ number写入HW interrupt ID配置寄存
 * 器就OK了，这时候生成的HW interrupt ID就是IRQ number，也就不需要进行mapping了
*/
