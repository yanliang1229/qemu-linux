...
#else
static inline void pci_add_dma_alias(struct pci_dev *dev, u8 devfn) {}
...
static inline struct pci_host_bridge *pci_find_host_bridge(struct pci_bus *bus) {return NULL;}
static inline bool pci_acs_path_enabled(struct pci_dev *start,
			  struct pci_dev *end, u16 acs_flags) {return false;}
#endif
