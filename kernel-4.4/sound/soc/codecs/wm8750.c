...
static struct snd_soc_dai_driver wm8750_dai_drv = {
	.name = "wm8750-hifi",
	.playback = {
			    ...
			    const struct i2c_device_id *id)
{
	...
	ret =  snd_soc_register_codec(&i2c->dev,
			&soc_codec_dev_wm8750, &wm8750_dai_drv, 1);
	return ret;
}
