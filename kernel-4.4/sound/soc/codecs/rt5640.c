...
static struct snd_soc_dai_driver rt5640_dai_driver[] = {
	{
		.name = "rt5640-aif1",
		.id = RT5640_AIF1,
		.playback = {
...
static struct snd_soc_codec_driver soc_codec_driver_rt5640 = {
	.probe = rt5640_probe,
		    ...
		    const struct i2c_device_id *id)
{
	...
	return snd_soc_register_codec(&i2c->dev, &soc_codec_driver_rt5640,
				      rt5640_dai_driver, ARRAY_SIZE(rt5640_dai_driver));
}
